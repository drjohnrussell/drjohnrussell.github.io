...
description: "Looking at course enrollments from a teacher perspective"
date: 03-16-2022
...
I walked through the Solution to this problem [a month ago](https://www.thejohnrussell.com/2022-02-17-bipartite-case-i/), but I wanted to return to it because it looked at this from a course perspective, instead of from a teacher perspective.
...
![TeachersByContent](img/image003.png)
...
![TeachersByBorough](img/image005.png)
